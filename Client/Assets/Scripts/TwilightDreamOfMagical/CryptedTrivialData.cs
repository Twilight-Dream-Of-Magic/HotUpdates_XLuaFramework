...
namespace TwilightDreamOfMagical.CustomSecurity.UnsafeTool
{
	static class MaskGen
	{
		...
		[MethodImpl(MethodImplOptions.AggressiveInlining)]
		public static ushort CreateMask16NonZero()
		{
			ushort x;
			do
			{
		...
		[MethodImpl(MethodImplOptions.AggressiveInlining)]
		public static uint CreateMask32NonZero()
		{
			uint x;
			do
			{
		...
		[MethodImpl(MethodImplOptions.AggressiveInlining)]
		public static ulong CreateMask64NonZero()
		{
			ulong x;
			do
			{
	...
	public unsafe struct CryptedShort : IEquatable<CryptedShort>
	{
		...
		{
			mask = MaskGen.CreateMask16NonZero();
		...
		public short Value
		{
			...
			{
				EnsureInitialized();
				return (short)(encrypted ^ mask);
			}
			set
			{
				mask = MaskGen.CreateMask16NonZero();
				encrypted = (ushort)((ushort)value ^ mask);
			}
		}
	...
	public unsafe struct CryptedUShort : IEquatable<CryptedUShort>
	{
		...
		public ushort Value
		{
			...
			{
				EnsureInitialized();
				return (ushort)(encrypted ^ mask);
			}
			set
			{
				mask = MaskGen.CreateMask16NonZero();
				encrypted = (ushort)(value ^ mask);
			}
		}
	...
	public unsafe struct CryptedInt : IEquatable<CryptedInt>
	{
		...
		{
			mask = MaskGen.CreateMask32NonZero();
		...
		public int Value
		{
			...
			{
				EnsureInitialized();
				return (int)(encrypted ^ mask);
			}
			set
			{
				mask = MaskGen.CreateMask32NonZero();
				encrypted = ((uint)value) ^ mask;
			}
		}
	...
	public unsafe struct CryptedUInt : IEquatable<CryptedUInt>
	{
		...
		public uint Value
		{
			...
			{
				EnsureInitialized();
				return encrypted ^ mask;
			}
			set
			{
				mask = MaskGen.CreateMask32NonZero();
				encrypted = value ^ mask;
			}
		}
	...
	public unsafe struct CryptedLong : IEquatable<CryptedLong>
	{
		...
		{
			mask = MaskGen.CreateMask64NonZero();
		...
		public long Value
		{
			...
			{
				EnsureInitialized();
				return (long)(encrypted ^ mask);
			}
			set
			{
				mask = MaskGen.CreateMask64NonZero();
				encrypted = ((ulong)value) ^ mask;
			}
		}
	...
	public unsafe struct CryptedFloat : IEquatable<CryptedFloat>
	{
		...
		public float Value
		{
			...
			{
				EnsureInitialized();
				return BitConverter.Int32BitsToSingle((int)(encrypted ^ mask));
			}
			set
			{
				mask = MaskGen.CreateMask32NonZero();
	...
	public unsafe struct CryptedDouble : IEquatable<CryptedDouble>
	{
		...
		public double Value
		{
			...
			{
				EnsureInitialized();
				return BitConverter.Int64BitsToDouble((long)(encrypted ^ mask));
			}
			set
			{
				mask = MaskGen.CreateMask64NonZero();
