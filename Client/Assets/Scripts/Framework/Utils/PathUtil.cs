...
{
	/*   Roots   */
	private static string ReadOnlyRoot = Application.streamingAssetsPath + "/AssetBundles";
	private static string ReadWriteRoot => GetReadableAndWriteableRoot() + "/AssetBundles";
	...
	public static readonly string BundleOutputPath = Application.streamingAssetsPath + "/AssetBundles";
	// Resource lua scripts path
	...
	public static string GetReadableAndWriteableFolderPath(string folderName)
	{
		var fullPath = Path.Combine(GetReadableAndWriteableRoot(), folderName);
	...
	public static string GetReadableAndWriteableFilePath(string fileName)
	{
		var fullPath = Path.Combine(GetReadableAndWriteableRoot(), fileName);
		if (!File.Exists(fullPath))
			Debug.LogWarning($"[PathUtil] File path not found: {fullPath}");
		return fullPath;
	}
