...
namespace XLua.CSObjectWrap
{
    ...
    public class FrameworkConstantWrap 
    {
        public static void __Register(RealStatePtr L)
        {
            ...
            Utils.RegisterObject(L, translator, Utils.CLS_IDX, "VersionFileListName", FrameworkConstant.VersionFileListName);
            Utils.RegisterObject(L, translator, Utils.CLS_IDX, "ProtectedVersionFileListName", FrameworkConstant.ProtectedVersionFileListName);
            Utils.RegisterObject(L, translator, Utils.CLS_IDX, "ResourcesURL", FrameworkConstant.ResourcesURL);
